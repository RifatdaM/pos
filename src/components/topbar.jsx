...
const Topbar = () => {
  ...
  return (
    <header role="banner" className="sticky top-0 z-40 bg-white border-b border-gray-200 shadow-sm">
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex flex-col items-end text-sm">
              <time dateTime={time.toISOString()} className="font-semibold text-gray-900">
                {formattedTime}
              </time>
            ...
            {/* Divider */}
            <div className="hidden sm:block w-px h-8 bg-gray-200" aria-hidden="true"></div>
            ...
            <nav aria-label="Quick actions" className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2 pl-2 border-l border-gray-200">
                <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center text-white font-medium text-sm" aria-hidden="true">
                  A
                </div>
