      ...
      <div className="flex items-center justify-between px-3 py-2 md:p-3 border-b border-gray-200">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[11px] text-gray-500">{scannedProducts.length} available</p>
          </div>
        </div>

        {/* View Toggle - Compact */}
        <div className="flex items-center gap-0.5 bg-gray-100 rounded p-0.5" role="tablist" aria-label="View mode">
          <button
            type="button"
      ...
      <div className="p-2 md:p-3">
        {scannedProducts.length === 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center">
            ...
            <h3 className="text-sm font-medium text-gray-900 mb-1">Ready to Scan</h3>
            <p className="text-xs text-gray-500 max-w-xs">Scan barcodes or search to add products</p>
            <div className="mt-2 flex items-center gap-1.5 text-xs text-blue-600">
              <kbd className="px-1.5 py-0.5 bg-blue-50 rounded text-[10px] font-medium">F2</kbd>
